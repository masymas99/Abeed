...
<div class="container">
    ...
    <div class="card shadow" style="border-radius: 25px; background-color: white; padding: 20px;
        ...
        <p><strong style="color: #5d3b45;">Application Deadline:</strong> {{ $job->application_deadline }}</p> 
        <p><strong style="color: #5d3b45;">Status:</strong> {{ $job->status }}</p>
        <p><strong style="color: #5d3b45;">Skills Required:</strong> {{ $job->skills_required }}</p>
        <p><strong style="color: #5d3b45;">work type:</strong> {{ $job->work_type }}</p>
        <p><strong style="color: #5d3b45;">description:</strong> {{ $job->description }}</p>
    </div>
</div>
@endsection
