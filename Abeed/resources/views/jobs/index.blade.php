            ...
            <div class="row g-2">
                <div class="col-md-4">
                    <input type="text" class="form-control form-control-lg" name="search" placeholder="Search for jobs..."
                        value="{{ request('search') }}" style="border-radius: 10px; border: 1px solid #ffb6c1;">
                </div>
                                ...
                                <div style="font-size: 0.9rem" class="mt-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        <a href="{{ route('applications.create', $job) }}"
                                            ...
                                            width: 100%; padding: 10px 20px; background-color: #413579; color: white; text-align: center; text-decoration: none; border-radius: 15px; font-weight: bold;">
                                            Apply Now
                                        </a>
